...
// Maximum number in tables
  ...
  #define NWK_MAX_DEVICE_LIST     8  // Maximum number of devices in the
                                      // Assoc/Device list.
#endif
...
#define NWK_ADDRESSING_STOCHASTIC     0x02
  ...
  #define NWK_ROUTE_AGE_LIMIT 15       // 3 missed link satus frames
#endif

#if !defined ( MAX_RTG_SRC_ENTRIES )
  #define MAX_RTG_SRC_ENTRIES 72
#endif

#if !defined ( SRC_RTG_EXPIRY_TIME )
  #define SRC_RTG_EXPIRY_TIME 3   // seconds before the source route entry expires
#endif
  ...
  #define LINK_DOWN_TRIGGER          12   // Link is down if txCounter exceeds this
#endif
...
// Maximum number of relays in source routing
  ...
  #define DEF_NWK_RADIUS           15	//( 2 * BEACON_MAX_DEPTH )
#endif
